...
- Estatística t de este $\approx$  –14.4
- Valor-p $\approx$  0,00
- Intervalo de confiança 95% para a diferença: [–0,0074, –0,0056]
...
- Como $p \approx 0,00 < 0,05$, rejeitamos $H_0$ ao nível de 5%.
...
- O valor absoluto $|d| = 1,86$ caracteriza um **efeito grande**, 
...
- O tamanho do efeito padronizado ($d = -1,86$) foi grande.
